...
# ghcr.io/jquad-group/pipeline-trigger-operator-bundle:$VERSION and ghcr.io/jquad-group/pipeline-trigger-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/jquad-group/pipeline-trigger-operator
